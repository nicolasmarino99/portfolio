    ...
    return (
        <div className="SkillSet" id="Services">
            ...
            <div className="info-cv ">
              ...
              I am a curious, constant, and passionate person who loves to learn while being challenged with new projects. I also love to work in teams and meet people around the world, thus I know how to work in a team. Besides my love for computing, I like playing music, reading, doing sports, traveling, and learning languages.
              </p>
